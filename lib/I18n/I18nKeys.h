...
enum class StrId : uint16_t {
  ...
  STR_YOU_WIN,
  STR_SCORE_FORMAT,
  STR_SNAKE_SCORE_FORMAT,
  STR_SNAKE_SPEED_HINT,
  ...
  STR_MENU_FEATURES,
  STR_APPS,
  STR_HELP_KEEP_CLOCK_ALIVE,
  STR_HELP_SLEEP_REFRESH,
  STR_HELP_FADING_FIX,
  STR_HELP_TEXT_DARKNESS,
  STR_HELP_REFRESH_FREQ,
  STR_HELP_TEXT_AA,
  STR_HELP_DARK_MODE,
  STR_HELP_SLEEP_SCREEN,
  STR_HELP_FONT_FAMILY,
  STR_HELP_FONT_SIZE,
  STR_HELP_ORIENTATION,
  STR_HELP_HYPHENATION,
  STR_HELP_EMBEDDED_STYLE,
  STR_HELP_HIDE_BATTERY,
  STR_HELP_TIME_TO_SLEEP,
...
// Order: English, Беларуская, Català, Čeština, Dansk, Deutsch, Español, Suomi, Français, Italiano, Nederlands, Polski, Português (Brasil), Română, Русский, Svenska, Türkçe, Українська, Tiếng Việt
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {0, 11, 9, 4, 15, 3, 1, 14, 2, 12, 16, 13, 5, 8, 6, 7, 17, 10, 18};
