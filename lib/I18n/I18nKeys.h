...
extern const char* const STRINGS_SI[];
}  // namespace i18n_strings
...
enum class StrId : uint16_t {
  ...
  STR_EXT_FONT_PRIMARY,
  STR_EXT_FONT_SUPPLEMENT,
  STR_EXT_FONT_PRIMARY_DESC,
  STR_EXT_FONT_SUPPLEMENT_DESC,
  STR_FLASHCARD,
  STR_FLASHCARD_DECK_SELECT,
  STR_FLASHCARD_NEW,
  STR_FLASHCARD_DUE,
  STR_FLASHCARD_TOTAL,
  STR_FLASHCARD_IMPORT,
  STR_FLASHCARD_SETTINGS,
  STR_FLASHCARD_AGAIN,
  STR_FLASHCARD_HARD,
  STR_FLASHCARD_GOOD,
  STR_FLASHCARD_EASY,
  STR_FLASHCARD_SHOW,
  STR_FLASHCARD_DONE_MSG,
  STR_FLASHCARD_NEW_PER_DAY,
...
inline const char* const* getStringArray(Language lang) {
  switch (lang) {
    ...
    case Language::SI:
      return i18n_strings::STRINGS_SI;
    default:
      return i18n_strings::STRINGS_EN;
  }
}
...
// Order: English, Беларуская, Català, Čeština, Dansk, Deutsch, Español, Suomi, Français, Magyar, Italiano, Қазақша, Lietuvių, Nederlands, Polski, Português (Brasil), Română, Русский, Slovenščina, Svenska, Türkçe, Українська, Tiếng Việt
constexpr uint8_t SORTED_LANGUAGE_INDICES[] = {0, 11, 9, 4, 15, 3, 1, 14, 2, 20, 12, 18, 21, 16, 13, 5, 8, 6, 22, 7, 17, 10, 19};
