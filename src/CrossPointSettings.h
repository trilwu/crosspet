...
class CrossPointSettings {
 ...
 public:
  ...
  // Library sort mode
  enum LIBRARY_SORT_MODE { SORT_NATURAL = 0, SORT_ALPHA = 1, SORT_DATE = 2, SORT_SIZE = 3, LIBRARY_SORT_MODE_COUNT };
  ...
  // Library sort mode (natural, alpha, date, size)
  uint8_t librarySortMode = SORT_NATURAL;
