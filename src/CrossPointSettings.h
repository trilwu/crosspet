...
class CrossPointSettings {
 ...
 public:
  ...
  enum SHORT_PWRBTN { IGNORE = 0, SLEEP = 1, PAGE_TURN = 2, SCREEN_REFRESH = 3, READING_STATS_VIEW = 4, STAR_PAGE = 5, BLOCK_FRONT = 6, SYNC_WEATHER_TIME = 7, AUTO_PAGE_TURN = 8, KOREADER_SYNC = 9, SHORT_PWRBTN_COUNT };
  ...
  // Short power button click behaviour (single / double / triple click)
  uint8_t shortPwrBtn = IGNORE;
  uint8_t shortPwrBtn2Click = IGNORE;
  uint8_t shortPwrBtn3Click = IGNORE;
