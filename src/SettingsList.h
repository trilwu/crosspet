...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = {
      ...
      // keepClockAlive removed — drains ~3-4mA in deep sleep, users enable accidentally.
      // sleepRefreshInterval removed — only useful with keepClockAlive.
      ...
      SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                        {StrId::STR_NOTO_SERIF, StrId::STR_LEXEND, StrId::STR_BOKERLAM}, "fontFamily",
